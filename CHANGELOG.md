...
### Changed
- fix: resolve v0.4.0 UI bugs (7 issues) (#6)

## [0.4.0] - 2026-02-20

### Changed
- feat: Add VPN Setup page and HTTPS support (#5)

## [0.3.0] - 2026-02-20

### Changed
- Add web-based update management system (#4)

## [0.2.1] - 2026-02-20

### Changed
- docs: update VERSION-WORKFLOW for N-Guard VPN (#3)
...
[0.2.1]: https://github.com/nyonnguyen/n-guard-vpn/compare/v0.2.0...v0.2.1
[0.3.0]: https://github.com/nyonnguyen/n-guard-vpn/compare/v0.2.1...v0.3.0
[0.4.0]: https://github.com/nyonnguyen/n-guard-vpn/compare/v0.3.0...v0.4.0
[0.4.1]: https://github.com/nyonnguyen/n-guard-vpn/compare/v0.4.0...v0.4.1
